...
public class MainClient {
    ...
    public static void menu(){
        ...
        System.out.println("2. Si tienes codigo, accede aquí para consultas");     
        System.out.println("4. Ver codigo usuario guardado");
    ...
    public static void salir() throws ClassNotFoundException{
        ...
        if(palabra.equalsIgnoreCase("1")){//solo salimos
            ...
            try {
               ...
               // System.out.println("Tu codigo actual es: (en salir 3)"+codigoGlobal);
                if(codigoGlobal.equals("0")){
                    System.out.println("Escribe aquí el codigo.. si no es correcto no podrás cerrar sesión: ");
                    palabra = lector.next();
                    lector.nextLine();                    
